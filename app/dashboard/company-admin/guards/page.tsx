...
export default function ManageGuards() {
  ...
  return (
    <PageContainer className="max-w-6xl space-y-6">
      <GuardsPageHeader onAddGuard={() => setShowModal(true)} onTakeTour={tour.startGuardsTour} />

      <div id="tour-guards-stats" className="grid gap-4 md:grid-cols-3">
        {[
      ...
      <div id="tour-guards-tabs" className="flex gap-2 overflow-x-auto rounded-[1.2rem] border border-slate-100 bg-white p-2 shadow-sm">
        {[
