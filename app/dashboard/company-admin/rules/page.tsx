...
import { IdCard, Loader2, Camera, CheckCircle2, AlertCircle, Users, Briefcase, Car, Plus, Trash2, ListPlus, Lock, ClipboardList, MapPin, Crosshair, QrCode, Phone, Compass } from "lucide-react";
    ...
    <PageContainer className="max-w-6xl space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="space-y-6">
          <Card id="tour-rules-required" className="h-fit overflow-hidden rounded-[1.4rem] border-slate-100 shadow-sm bg-white">
          ...
          <Card id="tour-rules-host" className="h-fit overflow-hidden rounded-[1.4rem] border-slate-100 shadow-sm bg-white">
            <CardHeader className="pb-4">
              <CardTitle className="flex items-center gap-3 text-xl">
          ...
          <Card id="tour-rules-photo" className="h-fit overflow-hidden rounded-[1.4rem] border-slate-100 shadow-sm bg-white">
            <CardHeader className="pb-4">
              <CardTitle className="flex items-center gap-3 text-xl">
          ...
          <Card id="tour-rules-verification" className="h-fit overflow-hidden rounded-[1.4rem] border-slate-100 shadow-sm bg-white">
            <CardHeader className="pb-4">
              <CardTitle className="flex items-center gap-3 text-xl">
                <span className="rounded-2xl bg-blue-50 p-2 text-blue-600">
        ...
        <div className="space-y-6">
          <Card id="tour-rules-custom" className="h-fit overflow-hidden rounded-[1.4rem] border-slate-100 shadow-sm bg-white">
            <CardHeader className="pb-4">
              <CardTitle className="flex items-center gap-3 text-xl">
          ...
          <Card id="tour-rules-geofence" className="h-fit overflow-hidden rounded-[1.4rem] border-slate-100 shadow-sm bg-white">
            <CardHeader className="pb-4">
              <CardTitle className="flex items-center gap-3 text-xl">
