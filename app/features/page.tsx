...
const featureGroups = [
  {
    ...
    features: [
      { title: "Pre-Registration Passes", description: "Hosts and tenants can pre-schedule visitors in advance, providing them with digital QR passes for fast express gate check-in.", icon: CalendarCheck },
  ...
  {
    title: "PMS Integration & Architecture",
    eyebrow: "Enterprise & Real Estate Sync",
    heading: "Automate occupant sync with external management software.",
    description: "Connect Property Management Systems (PMS) to keep units and hosts automatically up to date.",
    features: [
      { title: "Directory Sync REST API", description: "Automate synchronization of units/departments and tenants/hosts via idempotent batch REST endpoints (/api/v1/sync/groups and /api/v1/sync/users) with Bearer token authentication.", icon: Database },
      { title: "Multi-Industry Dynamic Terminology", description: "Seamlessly adapt labels across check-in forms and passes for Residential Estates (House/Unit & Tenant), Commercial Suites, or Corporate Offices.", icon: SlidersHorizontal },
      { title: "Impossible Travel Anomaly Detection", description: "Detect and flag geographic velocity anomalies in real time when account logins or visitor passes originate from contradictory physical distances.", icon: ShieldCheck },
      { title: "Brute-Force Rate Limiting", description: "Sliding window rate limiters protect authentication and public check-in endpoints against credential stuffing and automated abuse.", icon: LockKeyhole },
    ],
  },
  {
